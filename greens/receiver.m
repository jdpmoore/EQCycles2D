    ...
    methods
        ...
        function obj = receiver(filename,earthModel)
            ...
            for k=1:length(filename)
                assert(2==exist(filename{k},'file'),['geometry:patch:file not found ' filename{k}]);
                ...
                switch ext
                    ...
                    otherwise
                        error(['geometry:patch:wrong file type ' filename{k}]);
                end
            end
            ...
            switch size(fm,2)
                ...
                otherwise
                    error('geometry:patch:receiver:coding error');
            end
