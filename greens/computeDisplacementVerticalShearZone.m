...
%
% Author: James D. P. Moore (earth@jamesdpmoore.com) - 10 Jun, 2016, Singapore.

assert(-1<=nu & 1/2>=nu,'computeDisplacementVerticalShearZone -1<nu<0.5');
assert(0<=min(x3),'computeDisplacementVerticalShearZone depth must be positive');
assert(0<=q3,'computeDisplacementVerticalShearZone depth must be positive');
