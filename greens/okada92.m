classdef okada92 < earthModel
    ...
    methods
        ...
        function o=okada92(G,nu)
            ...
            assert(0<=G,'okada92::rigidity must be positive.')
            assert(nu<=0.5,'okada92::Poisson''s ratio should be lower than 0.5.')
            assert(-1<=nu,'okada92::Poisson''s ratio should be greater than -1.')
