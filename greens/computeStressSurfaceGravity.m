function [s11,s12,s13,s22,s23,s33]=computeStressSurfaceGravity( ...
...
%
% Author: 
% James D. P. Moore (earth@jamesdpmoore.com) - 11 Jul, 2016,
% Earth Observatory of Singapore

assert(-1<=nu & 1/2>=nu,'computeStressVerticalShearZone -1<nu<0.5');
assert(0<=min(x3),'computeStressVerticalShearZone depth must be positive');
assert(0<=q3,'computeStressVerticalShearZone depth must be positive');
