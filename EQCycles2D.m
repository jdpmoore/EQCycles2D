...
%                                                      %
% % % % % % % % % % % % % % % % % % % % % % % % % % %  %
flt = receiver({'./Faults/fault_90.seg'},okada92(G,nu));
...
% % % % % % % % % % % % % % % % % % % % % % % % % % %  %
if viscoelastic
    shz=shearZoneReceiver({'./faults/lowercrust.shz'},shearZone16(G,nu));
    shz.x(:,1)=shz.x(:,1)+1;
    shz.xc(:,1)=shz.xc(:,1)+1;
    % rheology
...
% % % % % % % % % % % % % % % % % % % % % % % % % % %  %
topo=shearZoneReceiver({'./faults/topography.shz'},shearZone16(G,nu));
xlocs=topo.x;
xloc=topo.x(:,1);
xlocs(:,2)=0*xlocs(:,2);
